...
colcon build --symlink-install $OVERRIDING_OPTIONS --cmake-args $CMAKE_OPTIONS -DCMAKE_CXX_FLAGS="-fpermissive"
# -DNUMPY_INCLUDE_DIR=/usr/local/lib/python3.10/dist-packages/numpy/_core/include
